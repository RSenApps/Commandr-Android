...
public class QustomDialogBuilder extends AlertDialog.Builder {
    ...
    public QustomDialogBuilder(Context context) {
        ...
        mDialogView = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.qustom_dialog_layout, null);
        setView(mDialogView);
    ...
    public QustomDialogBuilder setCustomView(View v, Context context) {
